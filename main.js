...
document.getElementById("sketch_item").innerHTML = "Sketch to be drawn: " + sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function update_canvas() {
    ...
    document.getElementById("sketch_item").innerHTML = "Sketch to be drawn: " + random_sketch_name;
}
